...
public class Test_DownloadImage {
    ...
    public static String download(String urlPath,String savePath) throws Exception {
    	savePath = StaticResourceLocation.class.getResource("/").getPath();
        // 构造URL
...
//      int randomNo=(int)(Math.random()*1000000);
        String filename= "test" + urlPath.substring(urlPath.lastIndexOf("/")+1,urlPath.length());//获取服务器上图片的名称
