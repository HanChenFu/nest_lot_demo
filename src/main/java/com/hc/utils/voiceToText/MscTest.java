...
public class MscTest {
	...
	private static final String APPID = "5df1a47b";
	...
	private void Recognize() {
		...
		RecognizePcmfileByte("D:/audioConversion/upload_audio/20191212/c2534a9ee3a840138e3bf2cfb43e4e3d.pcm");
	}

	/**
	 * 自动化测试注意要点 如果直接从音频文件识别，需要模拟真实的音速，防止音频队列的堵塞
	 */
	public void RecognizePcmfileByte(String audio_path) {
...
//				"./iat_test.pcm");
		...
		try {
			fis = new FileInputStream(new File(audio_path));
			if (0 == fis.available()) {
